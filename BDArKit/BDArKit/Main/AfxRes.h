...
// Tab Control styles
#ifndef TCS_MULTILINE // new __in later versions of Win32
...
// Mode indicators __in status bar - these are routed like commands
...
#define AFX_IDW_RESIZE_BAR              0xE803  // OLE __in-place resize bar
#if _MFC_VER >= 0x0600
...
//  while __in print preview mode, and are not likely to conflict with
//  IDs your application may have used succesfully __in the past.
...
// for application title (defaults to EXE name or name __in constructor)
#define AFX_IDS_APP_TITLE               0xE000
// idle message bar line
#define AFX_IDS_IDLEMESSAGE             0xE001
// message bar line when __in shift-F1 help mode
...
// E810 -> E81F must be kept __in order for RANGE macros
...
//  These are not placed __in DAO Errors collection
